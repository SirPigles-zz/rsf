...
$settings['adminemail'] = "mozartben@gmail.com";
...
$settings['myfirechat_guest_enabled'] = "0";
...
$settings['steamlogin_avatar_size'] = "2";
...
$settings['bbname'] = "RaffleSmash Forums";
$settings['bburl'] = "http://forums.rafflesmash.com";
$settings['steamgroup_group_cache_time'] = "1";
$settings['serversboard_cache_time'] = "1";
$settings['canviewownwarning'] = "1";
$settings['captchaimage'] = "1";
$settings['myfirechat_flood_control'] = "0";
$settings['chatweesso_chatid'] = "";
$settings['chatweesso_chatid'] = "";
$settings['myfirechat_moderator_groups'] = "3,4,6";
$settings['myfirechat_moderator_users'] = "";
...
$settings['cpstyle'] = "";
$settings['cookiedomain'] = ".forums.rafflesmash.com";
$settings['cookiepath'] = "/";
...
$settings['myfirechat_max_messages'] = "15";
$settings['myfirechat_defaultroom'] = "1";
$settings['default_memberlist_sortby'] = "regdate";
$settings['default_memberlist_order'] = "ascending";
$settings['timezoneoffset'] = "-5";
...
$settings['myfirechat_enable_avatar'] = "1";
$settings['myfirechat_enable_basic_mycode'] = "1";
$settings['enablecalendar'] = "1";
$settings['myfirechat_global_chat_enabled'] = "1";
$settings['myfirechat_chat_enabled'] = "1";
$settings['contact'] = "1";
$settings['myfirechat_enable_custom_mycode'] = "1";
...
$settings['myfirechat_firebase_secret'] = "FTtJUAsxMGG0Rvs4yuO6MLvd7igKjmPADDfHF4hs";
$settings['myfirechat_firebase_url'] = "https://rafflesmash.firebaseio.com/";
$settings['forcelogin'] = "0";
$settings['portal_excludediscussion'] = "";
$settings['portal_announcementsfid'] = "-1";
$settings['modlist'] = "1";
$settings['redirects'] = "1";
$settings['useravatarrating'] = "pg";
$settings['htg_groups'] = "1,2,5,7";
...
$settings['homename'] = "RaffleSmash";
$settings['homeurl'] = "http://forums.rafflesmash.com/";
...
$settings['myfirechat_max_messages_length'] = "400";
$settings['myfirechat_max_room_name'] = "30";
...
$settings['maxnamelength'] = "70";
$settings['maxpostvideos'] = "1";
$settings['maxwarningpoints'] = "5";
...
$settings['failedcaptchalogincount'] = "2";
...
$settings['steamgroup_onoff'] = "1";
$settings['steamgroup_index_onoff'] = "1";
$settings['steamgroup_portal_onoff'] = "1";
...
$settings['steamlogin_api_key'] = "4C53DD539FB6986CDC63871F1CC36F1F";
$settings['steamgroup_group_name'] = "RaffleSmash";
$settings['purgespammerapikey'] = "";
$settings['subforumsindex'] = "2";
$settings['htg_tag'] = "hide";
...
$settings['steamlogin_update_avatar'] = "1";
$settings['steamlogin_update_username'] = "1";
$settings['uploadspath'] = "./uploads";
$settings['cdnurl'] = "";
$settings['dotfolders'] = "1";
$settings['usecdn'] = "0";
$settings['myfirechat_displayname_custom'] = "";
$settings['useerrorhandling'] = "1";
$settings['gzipoutput'] = "0";
$settings['usereferrals'] = "1";
$settings['allowthreadratings'] = "1";
$settings['myfirechat_displayname_username'] = "1";
