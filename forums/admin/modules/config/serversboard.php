...
if($mybb->input['action'] == "add" || $mybb->input['action'] == "edit" || !$mybb->input['action'])
{
	...
	$sub_tabs['serversboard_settinggroups'] = array( 
...
if($mybb->input['action'] == "add")
{
	...
	$form_container->output_row($lang->server_arma2qport."<em> *</em>",  $lang->server_arma2qport_desc, $form->generate_text_box('arma2qport', $mybb->input['arma2qport'], array('id' => 'arma2qport')), 'arma2qport', array(), array('id' => 'row_serversboard_arma2qport'));
	$form_container->output_row($lang->server_arma3qport."<em> *</em>",  $lang->server_arma3qport_desc, $form->generate_text_box('arma3qport', $mybb->input['arma3qport'], array('id' => 'arma3qport')), 'arma3qport', array(), array('id' => 'row_serversboard_arma3qport'));
...
//	$form_container->output_row($lang->server_dayzmodqport."<em> *</em>",  $lang->server_dayzmodqport_desc, $form->generate_text_box('dayzmodqport', $mybb->input['dayzmodqport'], array('id' => 'dayzmodqport')), 'dayzmodqport', array(), array('id' => 'row_serversboard_dayzmodqport'));
	$form_container->output_row($lang->server_minecraftqport."<em> *</em>",  $lang->server_minecraftqport_desc, $form->generate_text_box('minecraftqport', $mybb->input['minecraftqport'], array('id' => 'minecraftqport')), 'minecraftqport', array(), array('id' => 'row_serversboard_minecraftqport'));
	...
	$form_container->output_row($lang->server_rustqport."<em> *</em>",  $lang->server_rustqport_desc, $form->generate_text_box('rustqport', $mybb->input['rustqport'], array('id' => 'rustqport')), 'rustqport', array(), array('id' => 'row_serversboard_rustqport'));
