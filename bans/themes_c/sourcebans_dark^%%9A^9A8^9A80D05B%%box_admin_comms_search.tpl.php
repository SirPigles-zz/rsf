...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_comms_search.tpl', 148, false),)), $this); ?>
<div align="center">
...
:<?php echo $this->_tpl_vars['server']['port']; ?>
			    ...
			    <tr>
				    <td> </td>
				    <td> </td>
			        <td><?php echo smarty_function_sb_button(array('text' => 'Search','onclick' => "search_blocks();",'class' => 'ok','id' => 'searchbtn','submit' => false), $this);?>
</td>
			    </tr>
			   </table>
			   </div>
