...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_bans_search.tpl', 153, false),)), $this); ?>
<div align="center">
...
:<?php echo $this->_tpl_vars['server']['port']; ?>
				...
				<?php endif; ?>
			    <tr>
			        <td colspan="4"><?php echo smarty_function_sb_button(array('text' => 'Search','onclick' => "search_bans();",'class' => 'ok searchbtn','id' => 'searchbtn','submit' => false), $this);?>
</td>
			    </tr>
			   </table>
			   </div>
