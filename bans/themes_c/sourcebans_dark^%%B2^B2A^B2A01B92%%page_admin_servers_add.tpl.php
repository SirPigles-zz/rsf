<?php /* Smarty version 2.6.29, created on 2016-01-08 18:07:42
...
Server IP/Domain</div>
		    ...
		    <td>
		    	<div align="left">
		        	<input type="text" TABINDEX=1 class="submit-fields" id="address" name="address" value="<?php echo $this->_tpl_vars['ip']; ?>
" />
		      	</div>
...
Server Port</div>
		    ...
		    <td>
		    	<div align="left">
		      		<input type="text" TABINDEX=2 class="submit-fields" id="port" name="port" value="<?php if ($this->_tpl_vars['port']): ?><?php echo $this->_tpl_vars['port']; ?>
...
RCON Password</div>
		    ...
		    <td>
		    	<div align="left">
		        	<input type="password" TABINDEX=3 class="submit-fields" id="rcon" name="rcon" value="<?php echo $this->_tpl_vars['rcon']; ?>
" />
		      	</div>
...
RCON Password (Confirm)</div>
		    ...
		    <td>
		    <div align="left">
		    	<input type="password" TABINDEX=4 class="submit-fields" id="rcon2" name="rcon2" value="<?php echo $this->_tpl_vars['rcon']; ?>
" />
		    </div>
