<?php /* Smarty version 2.6.29, created on 2016-01-10 09:10:28
...
&thinsp;<img src="images/details.gif" alt="Comments" title="Comments" style="height:12px;width:12px;" />
		  <?php endif; ?>
        ...
        <td colspan="7" align="center">
          <div class="opener"> 
              ...
              <tr align="left">
                ...
                <?php if ($this->_tpl_vars['view_bans']): ?>
                <td width="30%" rowspan="<?php if ($this->_tpl_vars['ban']['unbanned']): ?>12<?php else: ?>10<?php endif; ?>" class="listtable_2 opener">
                  <div class="ban-edit">
                    <ul>
